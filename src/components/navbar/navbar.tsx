        ...
        <>
            <nav className="bg-white border-gray-200 mb-6">
                <div className="flex flex-wrap items-center justify-between mx-auto p-2">
                    ...
                    <span className="self-center text-2xl font-semibold whitespace-nowrap">Hetic commerce</span>
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
                            ...
                            {currentUser
                                ? <li onClick={() => signOut()}>
                                    <a href="#" className="block text-red-500 py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Se déconnecter</a>
                                </li>
                                : <li>
                                    <a href="/login" className="block text-blue-500 py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Se connecter</a>
                                </li>}
                        </ul>
                    </div>
                </div>
