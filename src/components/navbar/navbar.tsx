...
export default function Navbar() {
    const { currentUser, role, signOut } = useContext(AuthContext);
                    ...
                    <div className="flex items-end gap-3">
                        ...
                        <div className="">
                            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                                ...
                                {role === "seller"
                                    ? <li>
                                        <a href="/newArticle" className="block py-2 px-3 text-gray-900 rounded md:hover:text-primary-900 md:p-0">Ajouter un article</a>
                                    </li>
                                    : null}
                                {role === "seller"
                                    ? <li>
                                        <a href="/myArticles" className="block py-2 px-3 text-gray-900 rounded md:hover:text-primary-900 md:p-0">Voir mes articles</a>
                                    </li>
                                    : null}                                    
                            </ul>
                        </div>
